...
pub async fn save_creature_addon(
    ...
    debug_sql!(app, debug, SQL,
        ...
        .execute(pool)
        .await,
        guid, addon.path_id, addon.mount, addon.MountCreatureID, addon.StandState, addon.AnimTier, addon.VisFlags, addon.SheathState, addon.PvPFlags, addon.emote, addon.visibilityDistanceType, &addon.auras
